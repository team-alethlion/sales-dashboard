...
const INITIAL_TEMPLATES = [
  {
    ...
    content:
      "Hello {{customer_name}}, your order #{{order_id}} has been confirmed and is being processed. Thank you for choosing Code8!",
    channel: "both",
  },
  {
    id: "t2",
    ...
    content:
      "Huge Savings! Use code FLASH20 for 20% off all Electronics this weekend. Shop now at code8.store/sales",
    channel: "whatsapp",
  },
  {
    id: "t3",
    ...
    content:
      "The item you were watching, {{product_name}}, is back in stock! Grab yours before they are gone.",
    channel: "sms",
  },
];
...
const HISTORY_LOGS = [
  ...
  },
  {
    ...
    channel: "WhatsApp",
    content: "New arrival alert: Premium Coffee...",
    time: "Yesterday",
    status: "Read",
  },
  {
    ...
    channel: "SMS",
    content: "Payment received for INV-9021...",
    time: "2 days ago",
    status: "Failed",
  },
];
...
const MessagingPage: React.FC = () => {
  ...
  const [newTemplate, setNewTemplate] = useState({
    name: "",
    content: "",
    channel: "both" as "sms" | "whatsapp" | "both",
  });
    ...
    <div className="relative mx-auto w-[280px] h-[580px] bg-slate-900 rounded-[3rem] border-8 border-slate-800 shadow-2xl overflow-hidden group transition-all duration-500 hover:scale-[1.02]">
      ...
      <div className="h-full w-full bg-slate-100 dark:bg-slate-950 pt-8 flex flex-col">
        ...
        <div
          className={`p-4 ${
            messageChannel === "whatsapp"
              ? "bg-[#075e54]"
              : "bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b dark:border-slate-800"
        ...
        <div className="flex-1 p-3 space-y-4 overflow-y-auto flex flex-col justify-end">
          <div
            className={`self-end max-w-[85%] p-2 rounded-2xl rounded-tr-none shadow-sm animate-in slide-in-from-bottom-2 duration-300 ${
              messageChannel === "whatsapp"
                ? "bg-[#dcf8c6] dark:bg-teal-900 text-slate-800 dark:text-teal-50"
            ...
            <div
              className={`text-right mt-1 text-[8px] opacity-70 ${
                messageChannel === "whatsapp"
        ...
        <div className="p-3 bg-white dark:bg-slate-900 border-t dark:border-slate-800 flex items-center gap-2">
          ...
          <div
            className={`w-6 h-6 rounded-full flex items-center justify-center text-white ${
              messageChannel === "whatsapp" ? "bg-[#075e54]" : "bg-blue-600"
            }`}>
            <Send size={10} />
          </div>
        </div>
            ...
            <div className="lg:col-span-7 space-y-6">
                ...
                <div className="space-y-6">
                  <div>
                    <label className="text-[10px] font-black text-gray-400 uppercase ml-1 mb-2 block">
                      Recipients (Comma Separated or Search)
                    </label>
                  ...
                  <div>
                    ...
                    <div className="mt-2 flex justify-between px-1">
                      <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">
                        Supports placeholders: {"{{customer_name}}"},{" "}
                        {"{{order_id}}"}
                      </p>
                      <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">
              ...
              <div className="p-4 bg-amber-50 dark:bg-amber-950/20 border border-amber-100 dark:border-amber-900/30 rounded-2xl flex gap-4">
                ...
                <p className="text-[10px] font-bold text-amber-700 dark:text-amber-400 leading-relaxed uppercase tracking-wider">
                  Alert: WhatsApp messages require an active connection. SMS
                  charges 1 credit per 160 characters. Placeholders are
                  automatically populated during transmission.
                </p>
              </div>
            </div>
          ...
          <div className="animate-in fade-in slide-in-from-left-4 duration-500">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {templates.map((t) => (
                <div
                  key={t.id}
                  className="bg-white dark:bg-slate-900 p-6 rounded-3xl border border-gray-50 dark:border-slate-800 shadow-sm hover:border-teal-300 transition-all flex flex-col group h-full">
                  ...
                  <h4 className="text-sm font-black text-slate-800 dark:text-slate-100 uppercase tracking-tight mb-2">
                    {t.name}
                  </h4>
                  <p className="text-xs text-gray-400 dark:text-slate-500 font-medium leading-relaxed mb-6 line-clamp-3 italic">
                    "{t.content}"
                  </p>
                  <button
                    onClick={() => {
                      setMessageBody(t.content);
              ...
              <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-gray-50 dark:divide-slate-800">
                  {HISTORY_LOGS.map((log) => (
                    <tr
                      key={log.id}
                      className="hover:bg-gray-50/30 dark:hover:bg-slate-800/20 transition-colors group">
                      <td className="px-8 py-6 font-bold text-sm text-slate-700 dark:text-slate-200">
                        {log.recipient}
                      </td>
                      ...
                      <td className="px-8 py-6 max-w-[300px] truncate text-xs text-gray-400 dark:text-slate-500">
                        {log.content}
                      </td>
                      <td className="px-8 py-6 text-[11px] font-bold text-gray-400 uppercase tracking-tight">
                        {log.time}
                      </td>
                      <td className="px-8 py-6">
                        <span
                ...
                <div className="space-y-8 animate-in zoom-in-95 duration-300">
                  <div>
                    ...
                    <p className="text-sm text-gray-400 font-medium mt-2">
                      Step 1: Verify your communication endpoint
                    </p>
                  </div>

                  <div className="max-w-xs mx-auto">
                    <label className="text-[10px] font-black text-gray-400 uppercase mb-2 block text-left">
                  ...
                  <div className="flex justify-center gap-4">
                    <button
                      ...
                      className={`flex flex-col items-center gap-2 p-6 rounded-3xl border-2 transition-all w-40 ${
                        pairingMethod === "qr"
                          ? "border-teal-600 bg-teal-50/50 dark:bg-teal-900/10"
                ...
                <div className="space-y-8 animate-in zoom-in-95 duration-300">
                  ...
                  <div className="bg-white p-6 rounded-3xl shadow-xl border-8 border-gray-50 mx-auto w-fit">
                    {pairingMethod === "qr" ? (
                      ...
                      <div className="px-10 py-12 flex flex-col items-center gap-6">
                        <p className="text-4xl font-black tracking-[0.5em] text-slate-800">
                          4K2L-9X2Z
                        </p>
                  ...
                  <div className="flex justify-center gap-4">
                    <button
                      ...
                      className="px-8 py-3 bg-gray-100 dark:bg-slate-800 text-gray-500 rounded-2xl text-[10px] font-black uppercase tracking-widest">
                      Go Back
                    </button>
                    <button
                      onClick={() => setConnStep(1)}
                      className="px-8 py-3 bg-teal-50 dark:bg-teal-900/30 text-teal-600 rounded-2xl text-[10px] font-black uppercase tracking-widest">
                      Verify Link
                    </button>
                  </div>
                </div>
                ...
                <div
                  ...
                  className={`bg-white dark:bg-slate-900 p-8 rounded-[3rem] border-4 transition-all cursor-pointer relative overflow-hidden group ${
                    selectedPackage.id === pkg.id
                      ...
                      : "border-gray-50 dark:border-slate-800 hover:border-teal-200 shadow-sm"
                  }`}>
                  {pkg.bestValue && (
                    <div className="absolute top-0 right-0 bg-teal-600 text-white px-4 py-1 rounded-bl-2xl text-[10px] font-black uppercase tracking-widest">
                      Best Choice
                    </div>
                  )}
              ...
              <div className="flex flex-col md:flex-row gap-12 items-center">
                <div className="flex-1 space-y-6">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-[#339d3c] rounded-2xl flex items-center justify-center text-white font-black text-2xl shadow-lg">
                      M
                    </div>
                    <div>
                      <h3 className="text-xl font-black text-slate-800 dark:text-slate-100 tracking-tight uppercase italic">
                        Secure M-Pesa Checkout
                      </h3>
                      <p className="text-xs text-gray-400 font-medium">
                        Instant STK Push for seamless credit topup
                      </p>
                    </div>
                  </div>
                  ...
                  {showSuccess && (
                    <div className="p-4 bg-emerald-50 text-emerald-600 border border-emerald-100 rounded-2xl flex items-center gap-3 animate-in fade-in zoom-in-95">
                      ...
                      <span className="text-xs font-black uppercase tracking-widest">
                        Transaction Sent! Check your handset.
                      </span>
                    </div>
                  )}
                </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 py-8">
          ...
          <div className="relative w-full max-w-2xl bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl border border-gray-100 dark:border-slate-800 animate-in zoom-in-95 duration-300 overflow-hidden flex flex-col max-h-[90vh]">
            <div className="p-8 border-b border-gray-50 dark:border-slate-800 flex justify-between items-center bg-gray-50/20 dark:bg-slate-800/20 shrink-0">
              ...
              <button
                onClick={() => setShowTemplateModal(false)}
                className="p-2.5 text-gray-300 hover:text-rose-500 transition-all hover:rotate-90">
                <X size={24} />
              </button>
            </div>
            ...
            <form
              ...
              className="p-8 space-y-6 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-slate-800">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
              ...
              <div>
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest w-full mb-1">
                    Insert Variables:
                  </p>
                  {[
                    "customer_name",
