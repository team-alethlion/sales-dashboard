...
const CarriageKPIs: React.FC<CarriageKPIsProps> = ({ totalThisMonth, totalEntries, uniqueSuppliers }) => {
  return (
    <div className="lg:col-span-4 flex flex-col gap-6">
      <div className="bg-white dark:bg-slate-900 p-6 rounded-xl border border-gray-50 dark:border-slate-800 shadow-sm transition-all hover:scale-[1.01]">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-gray-50 dark:border-slate-800 shadow-sm flex flex-col justify-center">
      ...
      <div className="bg-teal-600 p-6 rounded-xl shadow-xl shadow-teal-900/20 text-white relative overflow-hidden group">
